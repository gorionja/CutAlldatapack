...
# ****************************************************************************** #
#> @File data/orion.cutall/oak/destroy.mcfunction
#> @Author ORiON
#> tellraw @a [{"text":"[DEBUG] run data/orion.cutall/oak/destroy","italic":true,"color":"red"}]
# ****************************************************************************** #
...
execute if score use_auto_collect_flg CAD_Setting matches 1 run function orion.cutall:oak/use.auto.collect